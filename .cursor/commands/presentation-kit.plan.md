...
**CRITICAL: Read Design Principles in SKILL.md**
...
2. **Choose appropriate color palette**:
   - Review color palettes in SKILL.md (lines 73-103)
...
4. **Choose visual treatments** from SKILL.md (lines 106-157):
...
**Color Palette**: Deep Purple & Emerald (Palette #6 from SKILL.md)
